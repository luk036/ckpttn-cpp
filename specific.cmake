...
# print_target_properties(cppcoro) if(cppcoro_ADDED) message(STATUS "Found
# cppcoro: ${cppcoro_SOURCE_DIR}") add_library(cppcoro::cppcoro INTERFACE
# IMPORTED GLOBAL) target_include_directories(cppcoro::cppcoro SYSTEM INTERFACE
# ${cppcoro_SOURCE_DIR}/include) endif(cppcoro_ADDED)
